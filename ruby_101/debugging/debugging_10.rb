...
# try a simple implementation of TF-IDF, a measure of the 
# information content a term holds for a particular document 
# in a document collection. However, he just started learning 
# to code and somehow his numbers do not match what is expected. 
# He knows you're enrolled in an awesome developer school, so he 
# asks you to have a look.
